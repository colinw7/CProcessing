...
void linea(PVectorP p1, PVectorP p2) {
...
void striscia(float del, PVectorP p1, PVectorP p2, PVectorP p3, PVectorP p4)
{
...
void rettangolo_bianco(PVectorP pt1, PVectorP pt2, PVectorP pt3, PVectorP pt4)
{
  PVectorP p1 = proietta(pt1);
  PVectorP p2 = proietta(pt2);
  PVectorP p3 = proietta(pt3);
  PVectorP p4 = proietta(pt4);
...
void rettangolo_rigato(PVectorP pt1, PVectorP pt2, PVectorP pt3, PVectorP pt4)
{
...
void rettangolo_nero(PVectorP pt1, PVectorP pt2, PVectorP pt3, PVectorP pt4)
{
  PVectorP p1 = proietta(pt1);
  PVectorP p2 = proietta(pt2);
  PVectorP p3 = proietta(pt3);
...
void semaforox(PVectorP pt0)
{
  ...
  rettangolo_bianco(new PVector(pt0->x -4, 4, pt0->z), new PVector(pt0->x -4, 5, pt0->z),
                    new PVector(pt0->x -9, 5, pt0->z), new PVector(pt0->x -9, 4, pt0->z));
  rettangolo_bianco(new PVector(pt0->x-11, 4, pt0->z), new PVector(pt0->x-11, 5, pt0->z),
                    new PVector(pt0->x-19, 5, pt0->z), new PVector(pt0->x-19, 4, pt0->z));
  rettangolo_bianco(new PVector(pt0->x-21, 4, pt0->z), new PVector(pt0->x-21, 5, pt0->z),
                    new PVector(pt0->x-26, 5, pt0->z), new PVector(pt0->x-26, 4, pt0->z));
}

// ------------------------------------------------------------

void semaforoz(PVectorP pt0)
{
  ...
  rettangolo_bianco(new PVector(pt0->x, 4, pt0->z -4), new PVector(pt0->x, 5, pt0->z -4),
                    new PVector(pt0->x, 5, pt0->z -9), new PVector(pt0->x, 4, pt0->z -9));
  rettangolo_bianco(new PVector(pt0->x, 4, pt0->z-11), new PVector(pt0->x, 5, pt0->z-11),
                    new PVector(pt0->x, 5, pt0->z-16), new PVector(pt0->x, 4, pt0->z-16));
}
...
void dlinea(PVectorP p1, PVectorP p2) {
  dlinea((int)p1->x, (int)p1->y, (int)p2->x, (int)p2->y);
}

// ------------------------------------------------------------

void box3d(PVectorP pt1, PVectorP pt2)
{
  PVectorP p1 = proietta(new PVector(pt1->x, pt1->y, pt2->z));
  PVectorP p2 = proietta(new PVector(pt1->x, pt2->y, pt2->z));
  PVectorP p3 = proietta(new PVector(pt1->x, pt1->y, pt1->z));
  PVectorP p4 = proietta(new PVector(pt1->x, pt2->y, pt1->z));
  PVectorP p5 = proietta(new PVector(pt2->x, pt1->y, pt1->z));
  PVectorP p6 = proietta(new PVector(pt2->x, pt2->y, pt1->z));
  PVectorP p7 = proietta(new PVector(pt2->x, pt1->y, pt2->z));
...
void cilindro3d(PVectorP pt, float h, int nrseg, float rad, boolean contorno)
{
  ARRAY2D(PVector, PVectorGrid)

  PVectorGrid pv = PVectorGrid(nrseg, 2);
...
void pilotis(PVectorP pt0, float dex, float dez, float h)
{
  int nrx = int((dex - 1) / 6);
  int nrz = int((dez - 1) / 6);
...
void basamento(PVectorP pt, float h) {
  ...
  rettangolo_rigato(new PVector(pt->x, 6, pt->z+2), new PVector(pt->x, h-2, pt->z+2),
                    new PVector(pt->x, h-2, pt->z+28), new PVector(pt->x, 6, pt->z+28));

  for (int i=0; i<nr1; i++) {
    rettangolo_rigato(new PVector(pt->x, 0, pt->z+2+i*inter1), new PVector(pt->x, 4, pt->z+2+i*inter1),
                      new PVector(pt->x, 4, pt->z+1+(i+1)*inter1), new PVector(pt->x, 0, pt->z+1+(i+1)*inter1));
  }

  rettangolo_nero(new PVector(pt->x+2, 6, pt->z), new PVector(pt->x+2, h-2, pt->z),
                  new PVector(pt->x+28, h-2, pt->z), new PVector(pt->x+28, 6, pt->z));

  for (int i=0; i<nr2; i++) {
    rettangolo_nero(new PVector(pt->x+2+i*inter2, 0, pt->z), new PVector(pt->x+2+i*inter2, 4, pt->z),
                    new PVector(pt->x+1+(i+1)*inter2, 4, pt->z), new PVector(pt->x+1+(i+1)*inter2, 0, pt->z));
  }
}

// ------------------------------------------------------------

void albero(PVectorP pt0) {
  PVectorP pt1 = pt0->get();

  pt1->y += 4;

  PVectorP pt2 = pt1->get();

  pt2->x += 2;
  pt2->z -= 2;

  PVectorP pp0 = proietta(pt0);
  PVectorP pp1 = proietta(pt1);
  PVectorP pp2 = proietta(pt2);
...
void palazzo(PVectorP pt)
{
  ...
  switch (tipo) {
    case 0:
      ...
      rettangolo_bianco(new PVector(pt->x, h, pt->z), new PVector(pt->x+30, h, pt->z),
                        new PVector(pt->x+30, h, pt->z+30), new PVector(pt->x, h, pt->z+30));
    ...
    case 6: // giardino
      ...
      for (int i=0; i<10; i++) {
        ...
        PVectorP pt0 = new PVector(pt->x+26-px, pt->y+1, pt->z+26-pz+px);
  ...
  if (insegne) {
    ...
    rettangolo_bianco(new PVector(pt->x+ipos, 4, pt->z-1), new PVector(pt->x+ipos, 4+ih, pt->z-1),
                      new PVector(pt->x+ipos, 4+ih, pt->z-1-iw), new PVector(pt->x+ipos, 4, pt->z-1-iw));
    ...
    rettangolo_bianco(new PVector(pt->x-1, 4, pt->z+ipos), new PVector(pt->x-1, 4+ih, pt->z+ipos),
                      new PVector(pt->x-1-iw, 4+ih, pt->z+ipos), new PVector(pt->x-1-iw, 4, pt->z+ipos));
